...
import WishListButton from "@components/wishList/wish-list-button";
...
const Header: React.FC<headerProps> = ({ home }) => {
  ...
  return home ? (
    ...
    >
      <div className="fixed z-20 w-full h-16 px-4 text-gray-700 transition duration-200 ease-in-out bg-white innerSticky body-font sm:h-16 lg:h-20 md:px-8 lg:px-6">
        <div className="flex items-center justify-between mx-auto max-w-[1920px] h-full">
          <HeaderMenu
            home={home}
            className="hidden lg:flex space-x-5 lg:gap-0 xl:space-x-0 ltr:md:ml-6 rtl:md:mr-6  w-[470px] "
          />
          <Logo />
          ...
          <div className="items-center justify-end flex-shrink-0 hidden lg:flex gap-x-6 lg:gap-x-5 xl:gap-x-8 2xl:gap-x-10 w-[470px] ">
            <button
    ...
    >
      <div className="fixed z-20 w-full h-16 px-4 text-gray-700 transition duration-200 ease-in-out bg-white innerSticky body-font sm:h-16 lg:h-20 md:px-8 lg:px-6">
        <div className="flex items-center justify-center mx-auto max-w-[1920px] h-full">
          <Logo />

          <HeaderMenu className="hidden lg:flex space-x-5 lg:gap-0 xl:space-x-0 ltr:md:ml-6 rtl:md:mr-6 ltr:xl:ml-10 rtl:xl:mr-10" />
