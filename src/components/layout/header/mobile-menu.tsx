...
import { useHeaderMenu } from "./header-menu";

const social = [
  {
    id: 0,
    link: "https://m.facebook.com/VikikFashion/",
    icon: <IoLogoFacebook />,
    className: "facebook",
    title: "text-facebook",
  },
  ...
  {
    id: 3,
    link: "https://www.instagram.com/vikikfashion/?hl=en",
