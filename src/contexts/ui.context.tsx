...
export const UIProvider: React.FC = (props) => {
  ...
  const openWishlist = () => dispatch({ type: "OPEN_WHISLIST" });
  const closeWishlist = () => dispatch({ type: "CLOSE_WHISLIST" });
